...
final class WP_Recovery_Mode_Key_Service {
	 ...
	 *
	 * @since 5.2.0
	 * @since x.y.z The stored key is now hashed using wp_hash_value() instead of phpass.
	 *
	...
	public function validate_recovery_mode_key( $token, $key, $ttl ) {
		...
		if ( ! wp_verify_hashed_value( $key, $record['hashed_key'] ) ) {
	 ...
	 *
	 * @since 5.2.0
	 * @since x.y.z Each key is now hashed using wp_hash_value() instead of phpass.
	 ...
	 *
	 * @since 5.2.0
	 * @since x.y.z Each key should now be hashed using wp_hash_value() instead of phpass.
	 *
	 * @param array $keys {
	 *     Associative array of token => data pairs, where the data is an associative
	 *     array of information about the key.
