...
function wp_default_scripts( $scripts ) {
	...
	did_action( 'init' ) && $scripts->localize(
		...
		array(
			...
			'broken' => __( 'An unexpected error occurred while processing your request. Please try again later.' ),
		)
	);
	...
	did_action( 'init' ) && $scripts->localize(
		...
		array(
			...
			'cheatin'                 => __( 'An unexpected error occurred. Please try again later.' ),
